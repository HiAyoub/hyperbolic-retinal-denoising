...
After running [`notebooks/02_euclidean_baseline_random_split.ipynb`](../../notebooks/02_euclidean_baseline_random_split.ipynb) on Kaggle, download the following artifacts from `/kaggle/working/` into this folder:

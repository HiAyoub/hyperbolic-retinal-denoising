...
After running [`notebooks/05_poincare_optimized.ipynb`](../../notebooks/05_poincare_optimized.ipynb) on Kaggle, download the following artifacts from `/kaggle/working/` into this folder:

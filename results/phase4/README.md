...
After running [`notebooks/06_hyperbolic_encoder.ipynb`](../../notebooks/06_hyperbolic_encoder.ipynb) on Kaggle, download the following artifacts from `/kaggle/working/` into this folder:
